                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="choose-block" style="<?php echo $bg?>; opacity:1; background: url('<?php echo $home_block['background']?>'); background-size:cover; background-position:center; text-shadow: 0 0 4px rgba(0,0,0,1)">
