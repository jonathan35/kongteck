            ...
            foreach((array)$developers as $developer){?>
              <div class="carousel-item <? if($o==0){?>active<? }?>">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3" style="background-position: center; background-repeat: no-repeat; background-size: contain; height: 100px; background-image:url('<?php echo $n['developer_photo']?>')">
                    </div>
                    <?php }?>
                </div>                     
              </div>
