...
$fields = array('id', 'brand', 'photo', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
$label['brand'] = 'Brands & Year (eg. Perodua 2011)';
...
*/
$cols = $items =array();
$cols = array('Photo' => 2, 'Brand & Year' => 3, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 1);//Column title and width
$items['Brand & Year'] = array('brand');
